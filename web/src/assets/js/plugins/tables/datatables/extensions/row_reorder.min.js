...
*/
(function (d) { typeof define === 'function' && define.amd ? define(['jquery', 'datatables.net'], function (f) { return d(f, window, document) }) : typeof exports === 'object' ? module.exports = function (f, g) { f || (f = window); if (!g || !g.fn.dataTable)g = require('datatables.net')(f, g).$; return d(g, f, f.document) } : d(jQuery, window, document) })(function (d, f, g, m) {
...
a + b.offsetTop, b = !0 === e ? b.offsetLeft : typeof e === 'number' ? b.offsetLeft + e : c + b.offsetLeft; a < 0 ? a = 0 : a + this.s.domCloneOuterHeight > this.s.documentOuterHeight && (a = this.s.documentOuterHeight - this.s.domCloneOuterHeight); this.dom.clone.css({top: a, left: b})
  },
  _emitEvent: function (c, b) { this.s.dt.iterator('table', function (a) { d(a.nTable).triggerHandler(c + '.dt', b) }) },
  _eventToPage: function (c, b) { return c.type.indexOf('touch') !== -1 ? c.originalEvent.touches[0]['page' + b] : c['page' + b] },
  ...
  _mouseMove: function (c) {
    this._clonePosition(c); for (var b = this._eventToPage(c, 'Y') - this.s.bodyTop, a = this.s.middles, e = null, i = this.s.dt, j = i.table().body(), g = 0, f = a.length; g < f; g++) if (b < a[g]) { e = g; break }e === null && (e = a.length); if (this.s.lastInsert === null || this.s.lastInsert !==
e)e === 0 ? this.dom.target.prependTo(j) : (b = d.unique(i.rows({page: 'current'}).nodes().toArray()), e > this.s.lastInsert ? this.dom.target.insertAfter(b[e - 1]) : this.dom.target.insertBefore(b[e])), this._cachePositions(), this.s.lastInsert = e; this._shiftScroll(c)
  },
  _mouseUp: function () {
...
0; for (e = h.length; a < e; a++) { var d = b.row(h[a].node).data(); m(d, h[a].newData); b.columns().every(function () { this.dataSrc() === i && b.cell(h[a].node, this.index()).invalidate('data') }) }c._emitEvent('row-reordered', q); b.draw(!1)
  ...
  _shiftScroll: function (c) {
    var b = this, a = this.s.scroll, e = !1, d = c.pageY - g.body.scrollTop, f, h; d < 65 ? f = -5 : d > a.windowHeight - 65 && (f = 5); a.dtTop !== null && c.pageY < a.dtTop + 65 ? h = -5 : a.dtTop !== null && c.pageY > a.dtTop + a.dtHeight - 65 && (h = 5); f || h ? (a.windowVert = f, a.dtVert = h, e = !0) : this.s.scrollInterval && (clearInterval(this.s.scrollInterval), this.s.scrollInterval = null); !this.s.scrollInterval && e && (this.s.scrollInterval =
...
c)
  ...
  }); l.register('rowReorder.disable()', function () { return this.iterator('table', function (c) { c.rowreorder && (c.rowreorder.c.enable = !1) }) }); k.version = '1.2.4'; d.fn.dataTable.RowReorder = k; d.fn.DataTable.RowReorder = k; d(g).on('init.dt.dtr', function (c, b) { if (c.namespace === 'dt') { var a = b.oInit.rowReorder, e = h.defaults.rowReorder; if (a || e)e = d.extend({}, a, e), !1 !== a && new k(b, e) } }); return k
})
