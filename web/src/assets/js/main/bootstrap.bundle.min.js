...
!function (t, e) {
    ...
    return t.next = function () {
      ...
      if (t === W ? (n = q, i = z, r = U) : (n = G, i = X, r = B), l && k(l).hasClass(Q)) {
        ...
        if (k(this._element).hasClass(Y)) {
          ...
          k(s).removeClass(Q), k(l).addClass(Q), this._isSliding = !1, k(this._element).trigger(h)
        }
        f && this.cycle()
      }
  ...
  function Qt (t, e) {
    ...
    return (i && !n ? e.contains(a) : e === a && 'BODY' !== a.nodeName) && (h = function (t, e) {
      var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], i = jt(e, 'top'), r = jt(e, 'left'),
        o = n ? -1 : 1
    ...
    if ('viewport' === i) {
      o = function (t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], n = t.ownerDocument.documentElement,
          i = Qt(t, n), r = Math.max(n.clientWidth, window.innerWidth || 0),
  ...
  var me, _e, ve, Ee, ye, be, Te, Ce, we, Ie, De, Ae, Se, Oe, Ne, ke, Le, Pe, xe, je, Me, Re, He, We, Fe, Ue, Be, Ke,
    Ve, Qe, Ye, Ge, qe, ze, Xe, Je, Ze, $e, tn, en, nn, rn, on, sn, an, ln, cn, fn, hn, un, dn, pn, gn, mn, _n, vn, En,
    yn, bn, Tn, Cn, wn, In, Dn, An, Sn, On, Nn, kn, Ln, Pn, xn, jn, Mn, Rn, Hn, Wn, Fn, Un, Bn, Kn, Vn, Qn, Yn, Gn, qn,
    zn, Xn, Jn, Zn, $n, ti, ei, ni, ii, ri, oi, si, ai, li, ci, fi, hi, ui, di, pi, gi, mi, _i, vi, Ei, yi, bi,
